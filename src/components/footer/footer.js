...
const Footer = () => {
    return <div className="block-wrapper" style={{ backgroundColor: "#1b242f" }} >
        <div className="social-media-wrapper">
            <a href="https://www.linkedin.com/in/kranti-brid-2b1585102/" target="_blank" className="socail-media">
                <img src={`${linkedin}`} alt="linkind" style={{ height: "50%" }} />
            </a>
            <div className="socail-media">
                <img src={`${github}`} alt="github" style={{ height: "50%" }} />
            </div>
            <a href="https://medium.com/@krantibrid" target="_blank" className="socail-media">
                <img src={`${medium}`} alt="medium" style={{ height: "50%" }} />
            </a>
            <a href="https://krantibrid.blogspot.com/" target="_blank" className="socail-media">
